...
#0809
#python3  main.py  --mode=train --model_name=model_2 --lr=0.0005 --cnn_filter_size=5 --dropout=0.8 --epoch=2
#python3  main.py  --mode=test --model_name=model_2 --lr=0.0005 --cnn_filter_size=5 --dropout=0.8 --epoch=2